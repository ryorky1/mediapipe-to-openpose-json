...
Run from Terminal in /src directory using:
python -m plot.json {input json file} {output json file} {width} {height}
python -m plot_json ./images/1lady_keypoints.jpg.json ./images/OpenPoseGT/output.jpg 1000 1000
python -m plot_json ./images/OpenPoseGT/A-pose_keypoints_GT.json ./images/OpenPoseGT/output.jpg 1500 1500
"""
