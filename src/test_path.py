...
def test(cfg: DictConfig):
    ...
    # matching_files = []
    # for root, dirs, files in os.walk('/home/rhino/projects/mediapipe-to-openpose-json/images/'):
    #     for file in files:
    #         # if any(file.endswith(ext) for ext in extensions):
    #             matching_files.append(os.path.join(root, file))
    # return matching_files
    directory = "/home/rhino/projects/mediapipe-to-openpose-json/images"
    ...
    # files = [f for f in os.listdir(directory) if os.path.isfile(os.path.join(cfg.files.test_img_path, f))]
...
def generate_MP_JSON(cfg: DictConfig):
	...
	img_folder = []
	for ext in ('*.png', '*.jpg', '*.jpeg'):
		img_folder.append(glob(join(str(cfg.files.test_img_path), ext)))
		print(img_folder)
	# print(img_folder)
